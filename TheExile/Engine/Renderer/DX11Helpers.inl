...
inline void CreateSwapChainDesc(unsigned int nWindowWidth, unsigned int nWindowHeight, unsigned int nSampleCount, 
								unsigned int nSampleQuality, DXGI_SWAP_CHAIN_DESC& d3dSwapChainDesc)
{
	...
	d3dSwapChainDesc.OutputWindow = hWindow;
...
inline void CreateViewport(unsigned int nWindowWidth, unsigned int nWindowHeight, D3D11_VIEWPORT& d3dViewport)
{
...
inline void CreateTextureDesc(unsigned int nWindowWidth, unsigned int nWindowHeight, DXGI_FORMAT d3dFormat, 
							  unsigned int nSampleCount, unsigned int nSampleQuality, unsigned int nBindFlags, 
							  unsigned int nCPUFlags, unsigned int nMiscFlags, D3D11_TEXTURE2D_DESC& d3dTextureDesc)
{
...
inline void CreateDSVDesc(unsigned int nFlags, DXGI_FORMAT d3dFormat, D3D11_DSV_DIMENSION d3dDimension, 
...
inline void CreateBufferDesc(unsigned int nByteWidth, D3D11_USAGE d3dUsage, unsigned int nBindFlags,
						 unsigned int nCPUAccessFlags, unsigned int nByteStride, D3D11_BUFFER_DESC& d3dBufferDesc)
{
