...
CGunpowder::CGunpowder( CObjectManager* _objManager, IObject* _parent ) : IObject( "Gunpowder" )
{
	m_cpParent = _parent;
	m_bActive = false;
	...
	CMesh* theMesh = CAssetManager::GetInstance()->GetPrefabMesh("GunPowder");
	m_cpRenderMesh = new CRenderMesh(theMesh,
		GRAPHICS->GetVertexShader(), GRAPHICS->GetPixelShader(),
		nullptr, nullptr, nullptr, L"../Game/Assets/Art/2D/Textures/Failbot_Gunpowder.dds" );
